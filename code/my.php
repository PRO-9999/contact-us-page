...
if (isset($_POST['name'])) {
    ...
    $sql = "INSERT INTO `contact us`.`contactform` (`name`, `email`, `password`, `message`) VALUES ('$name', '$email', '$password', '$message');";
...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Graduate&family=Tiny5&display=swap" rel="stylesheet">
</head>
<body>
  <?php
...
?>
    <div class="contact-form-container card">
        <h2><span>C</span> ont <span>a</span>ct U <span>s</span></h2>
        <form action="./my.php" method="post">
            <label for="name">Name:</label>
            <input type="text" id="name" name="name" required class="inpu">
...
<!-- INSERT INTO `contactform` (`name`, `email`, `password`, `message`) VALUES ('naini', 'nainihunhar:gamil.com', 'asd', 'asdasd'); -->
